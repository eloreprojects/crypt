...
var _AccountList = __webpack_require__(28);
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function componentWillMount() {
      ...
      fetch('/accounts').then(function (res) {
        return res.json();
      }).then(function (data) {
        console.log(data);
        _this2.setState({
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_AccountList2.default, { accounts: this.state.data })
      );
    }
  }]);
...
function AccountList(props) {
  var accounts = props.accounts.map(function (account) {
    return _react2.default.createElement(_Account2.default, { account: account.account, password: account.password });
  });
